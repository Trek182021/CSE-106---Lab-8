function GET(teacher_id) {
    ...
    // var url = "http://lodocus.pythonanywhere.com/teacherCourses/3";
    ...
    xhttp.onload= function() {
        ...
        for(i = 0; i < rep.length; i++) {
            document.getElementById("courseinfo").innerHTML += `<tr><td><a href="grades.html"> ${rep[i].Course} </a></td><td>${rep[i].Teacher}</td><td>${rep[i].Time}</td><td>${rep[i].Capacity}</td></tr>`
