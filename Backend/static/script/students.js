...
function signOut()
{
    window.location.href = "/logout"; //return to login html page
}
...
// function addCourseToYourClasses(course_id, student_id, grade)
// {
...
//     fetch("http://127.0.0.1:5000/", { method: "POST", body: JSON.stringify({ course_id, student_id, grade }) })
// }

// function deleteCourseFromYourClasses(course_id, student_id) 
// {
//     const table = document.querySelector('#yourClassesContent .centered-table tbody');
...
//         }
//     }
//     fetch("http://127.0.0.1:5000/", { method: "DELETE", body: JSON.stringify({ course_id, student_id }) })
// }
